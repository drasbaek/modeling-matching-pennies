...
ggsave(here::here("plots", "recovery", "alpha_recovery_all.jpg"), final_alpha_plot, width = 20, height = 10)
...
ggsave(here::here("plots", "recovery", "tau_recovery_all.jpg"), final_tau_plot, width = 20, height = 10)